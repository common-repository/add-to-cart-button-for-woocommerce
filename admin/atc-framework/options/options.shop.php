...
ATC::createSection(
	$prefix,
	array(
		'title'  => __( 'Button on Shop page', 'wk-add-to-cart-button-for-woocommerce' ),
		'icon'   => '',
		'fields' => array(
			array(
			...
			array(
				'id'          => 'atc_button_size',
				'type'        => 'dimensions',
				'title'       => __( 'Button Size', 'wk-add-to-cart-button-for-woocommerce' ),
