...
(function($) {
  ...
  function ATCAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  ATCAjaxChosen.prototype.init = function() {
  ...
  ATCAjaxChosen.prototype.events = function() {
  ...
  ATCAjaxChosen.prototype.search_field_focused = function() {
  ...
  ATCAjaxChosen.prototype.search_welcome_message = function() {
  ...
  ATCAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('atc-chosen', _this.options.data).done( function( response ) {
  ...
  ATCAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.atc-hidden-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.ATCChosenOrder($hidden_value, true);
  ...
  $.fn.ATCAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new ATCAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, ATCAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  ATCAbstractChosenOrder = (function() {

    function ATCAbstractChosenOrder() {}

    ATCAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    ATCAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    ATCAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    ATCAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    ATCAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    ATCAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    ATCAbstractChosenOrder.ATCChosenOrder = function(select, order, force) {
  ...
  $.fn.extend({
    ATCChosenOrder: function(order, force) {
      return _ATCChosenOrder.ATCChosenOrder(this, order, force);
    }
  });

  this._ATCChosenOrder = (function(_super) {
    __extends(_ATCChosenOrder, _super);

    function _ATCChosenOrder() {
      _ref = _ATCChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _ATCChosenOrder.relAttributeName = 'data-option-array-index';

    _ATCChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _ATCChosenOrder.getDOMElement = function(element) {
    ...
    _ATCChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _ATCChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _ATCChosenOrder;

  })(ATCAbstractChosenOrder);
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectATC = FormSerializer.serializeObject;
    $.fn.serializeJSONATC   = FormSerializer.serializeJSON;
  }
