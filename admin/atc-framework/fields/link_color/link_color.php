 ...
 *
 */
if( ! class_exists( 'ATC_Field_link_color' ) ) {
  class ATC_Field_link_color extends ATC_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'wk-add-to-cart-button-for-woocommerce' ),
        'hover'    => esc_html__( 'Hover', 'wk-add-to-cart-button-for-woocommerce' ),
        'active'   => esc_html__( 'Active', 'wk-add-to-cart-button-for-woocommerce' ),
        'visited'  => esc_html__( 'Visited', 'wk-add-to-cart-button-for-woocommerce' ),
        'focus'    => esc_html__( 'Focus', 'wk-add-to-cart-button-for-woocommerce' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="atc--title">'. $color_prop_value .'</div>';
          echo '<input type="text" name="'. $this->field_name('['. $color_prop_key .']') .'" value="'. $value[$color_prop_key] .'" class="atc-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
