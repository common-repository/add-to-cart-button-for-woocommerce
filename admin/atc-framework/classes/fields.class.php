 ...
 *
 */
if( ! class_exists( 'ATC_Fields' ) ) {
  abstract class ATC_Fields extends ATC_Abstract {
    ...
    public function field_after() {
      ...
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<p class="atc-text-desc">'. $this->field['desc'] .'</p>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<span class="atc-help"><span class="atc-help-text">'. $this->field['help'] .'</span><span class="fa fa-question-circle"></span></span>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<p class="atc-text-error">'. $this->field['_error'] .'</p>' : '';
